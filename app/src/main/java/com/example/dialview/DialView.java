...
public class DialView extends View {
    //Membuat label 4x berulang/iterasi
    ...
    //Radius lingkaran
    private float[] computerXYPosition(final int pos, final float radius){
        float[] result = mTempResult;
        //mengatur posisi label angka
...
//        mencari radius, default di titik tengah, kalo geser harus ditambahkan
        final float labelRadius = mRadius + 20;
